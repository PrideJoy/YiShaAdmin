    ...
    public class RepositoryFactory
    {
        public Repository BaseRepository()
        {
            ...
            GlobalContext.SystemConfig = new SystemConfig
            {
                ...
                DBConnectionString = "Server=121.40.104.247;Database=YiShaAdmin;User Id=zk;Password=123456;",
                DBCommandTimeout = 18000,
                DBBackup = "DataBase"
            };
            //string dbConnectionString = "Server=121.40.104.247;Database=YiShaAdmin;User Id=zk;Password=123456;";
